...
export default function TeacherDashboard() {
  ...
  const renderDashboard = () => (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Hero banner */}
      <div className="relative bg-gradient-to-br from-orange-500 via-orange-500 to-amber-400 rounded-3xl p-8 text-white overflow-hidden shadow-[0_20px_60px_rgba(249,115,22,0.3)]">
        <img
          src="/assets/dna.gif"
          alt=""
          aria-hidden="true"
        ...
        <div className="relative">
          <p className="text-orange-200 text-sm font-bold uppercase tracking-widest mb-1">Không gian giảng dạy</p>
          <h2 className="text-3xl font-black drop-shadow-sm">Dashboard Giảng viên 📚</h2>
          <p className="text-orange-100 mt-2 font-medium">Theo dõi học sinh, bài giảng và tỷ lệ hoàn thành của bạn.</p>
        </div>
      </div>
