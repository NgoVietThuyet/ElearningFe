...
export default function StudentDashboard() {
  const [activeSection] = useState<StudentSection>("dashboard");
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((course) => (
            <div
              key={course.id}
              className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group card-lift"
            >
